...
IMPLEMENT_DYNAMIC(CShowPictureDlg, CDialogEx)
	...
	CShowPictureDlg::CShowPictureDlg(bool isTrans,CWnd* pParent /*=NULL*/)
...
void CShowPictureDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_STATIC_PICTUREINFO, m_picCtr);
}
...
void CShowPictureDlg::changePictureSize(int w,int h)
{
	...
	pStatic = (CStatic*)GetDlgItem(IDC_STATIC_PICTUREINFO);
	RECT r,r1;
